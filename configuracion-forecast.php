...
<head>
    <meta charset="UTF-8">
    <title>Configuración Forecast | MRP</title>
...
<div class="container">
    <div class="card shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
            <h5 class="mb-0 text-black"><?php echo encabezadoMantenedor($pdo, 'Configuración Forecast'); ?></h5>
            <div class="d-flex gap-2">
                <button class="btn btn-primary btn-sm"
                        data-bs-toggle="modal"
                        data-bs-target="#modalForecastConfiguracion">
                    <i class="bi bi-plus-lg"></i> Agregar Configuración
                </button>
            </div>
        </div>
        <div class="card-body">
...
<script src="assets/js/configuracion_forecast.js?v=<?php echo filemtime(__DIR__ . '/assets/js/configuracion_forecast.js'); ?>"></script>
</body>
</html>
